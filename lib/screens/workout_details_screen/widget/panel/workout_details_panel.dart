...
import 'package:fitness_flutter/screens/workout_details_screen/widget/panel/execises_list.dart';
...
class WorkoutDetailsPanel extends StatelessWidget {
  ...
  const WorkoutDetailsPanel({Key? key, required this.workout}) : super(key: key);
